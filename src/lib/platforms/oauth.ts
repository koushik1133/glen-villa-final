...
export const CONNECT_SPECS: ConnectSpec[] = [
  {
    ...
    authorizeUrl: (r) =>
      `${META_OAUTH}?client_id=${encodeURIComponent(process.env.META_APP_ID ?? "")}&redirect_uri=${encodeURIComponent(r)}&response_type=code&scope=instagram_basic,instagram_content_publish,instagram_manage_insights,instagram_manage_comments,pages_show_list`,
  ...
  },
  {
    ...
    authorizeUrl: (r) =>
      `${META_OAUTH}?client_id=${encodeURIComponent(process.env.META_APP_ID ?? "")}&redirect_uri=${encodeURIComponent(r)}&response_type=code&scope=pages_manage_posts,pages_read_engagement,pages_manage_engagement,read_insights`,
    envVars: ["META_APP_ID", "META_APP_SECRET"],
  },
  {
    channel: "whatsapp",
    ...
    authorizeUrl: (r) =>
      `${META_OAUTH}?client_id=${encodeURIComponent(process.env.META_APP_ID ?? "")}&redirect_uri=${encodeURIComponent(r)}&response_type=code&scope=whatsapp_business_messaging,whatsapp_business_management,business_management`,
  ...
  },
  {
    ...
    authorizeUrl: (r) =>
      `https://www.tiktok.com/v2/auth/authorize/?client_key=${encodeURIComponent(process.env.TIKTOK_CLIENT_KEY ?? "")}&redirect_uri=${encodeURIComponent(r)}&response_type=code&scope=video.publish,video.list,user.info.basic`,
  ...
  },
  {
    ...
    authorizeUrl: (r) =>
      `https://www.linkedin.com/oauth/v2/authorization?client_id=${encodeURIComponent(process.env.LINKEDIN_CLIENT_ID ?? "")}&redirect_uri=${encodeURIComponent(r)}&response_type=code&scope=w_organization_social%20r_organization_social`,
  ...
  },
  {
    ...
    authorizeUrl: (r) =>
      `https://twitter.com/i/oauth2/authorize?client_id=${encodeURIComponent(process.env.X_CLIENT_ID ?? "")}&redirect_uri=${encodeURIComponent(r)}&response_type=code&scope=tweet.read%20tweet.write%20users.read%20offline.access&code_challenge=challenge&code_challenge_method=plain`,
  ...
  },
  {
    ...
    authorizeUrl: (r) =>
      `https://accounts.google.com/o/oauth2/v2/auth?client_id=${encodeURIComponent(process.env.GOOGLE_CLIENT_ID ?? "")}&redirect_uri=${encodeURIComponent(r)}&response_type=code&access_type=offline&prompt=consent&scope=${encodeURIComponent("https://www.googleapis.com/auth/business.manage")}`,
    envVars: ["GOOGLE_CLIENT_ID", "GOOGLE_CLIENT_SECRET"],
  },
  {
    channel: "meta_ads",
    ...
    authorizeUrl: (r) =>
      `${META_OAUTH}?client_id=${encodeURIComponent(process.env.META_APP_ID ?? "")}&redirect_uri=${encodeURIComponent(r)}&response_type=code&scope=ads_read,ads_management,business_management`,
  ...
  },
  {
    ...
    authorizeUrl: (r) =>
      `https://accounts.google.com/o/oauth2/v2/auth?client_id=${encodeURIComponent(process.env.GOOGLE_CLIENT_ID ?? "")}&redirect_uri=${encodeURIComponent(r)}&response_type=code&access_type=offline&prompt=consent&scope=${encodeURIComponent("https://www.googleapis.com/auth/adwords")}`,
