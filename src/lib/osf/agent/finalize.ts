...
function analyzeSentiment(
  ...
  if (
    /(too expensive|very expensive|overpriced|out of (my )?budget|not interested|no thanks|too far|too costly|disappointed|waste|useless|worst|cheat|scam|fraud|misleading|angry|frustrat)/.test(
      t,
    )
  ) {
    return "negative";
  ...
  if (
    ...
    /(interested|love it|looks great|beautiful|excellent|perfect|amazing|wonderful|impressed|ready to|want to (buy|book|visit)|book (a )?visit|site visit|let'?s proceed|sounds good|very good|good deal|👍|❤|😍)/.test(
      t,
    )
  ) {
    return "positive";
