  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <Link href={`/os/analytics/reports?range=${range}`} className="btn-ghost h-9 py-0 text-[13px]">
            Export data
...
/**
 * Shown only when the gate fails. `/os` is where someone lands on a fresh clone,
