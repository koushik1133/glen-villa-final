...
function href(active: Active, drop?: keyof Active): string {
  ...
  return query ? `/os/crm/leads?${query}` : "/os/crm/leads";
}
  ...
  return (
    <>
      ...
      <Card className="mb-5">
        ...
        <form method="GET" action="/os/crm/leads" className="grid gap-3 sm:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="flex items-end gap-2 lg:col-span-5">
            ...
            {chips.length > 0 && (
              <Link href="/os/crm/leads" className="btn-ghost">
                Clear all
              </Link>
            )}
          </div>
          ...
          <Empty
            action={
              chips.length > 0 ? (
                ...
                <Link href="/os/simulator" className="btn-ghost">
                  Open the simulator
                </Link>
              )
            }
