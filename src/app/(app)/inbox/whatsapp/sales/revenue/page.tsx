...
import { Card, Empty, PageHeader, SetupNotice, Stat, formatCr, formatInr, formatPercent } from "@/components/osf/ui";
import { BarsChart, TrendChart } from "@/components/osf/charts";
  ...
  return (
    <>
      <PageHeader
        ...
        actions={
          <Link href="/inbox/whatsapp/sales/bookings" className="btn-ghost">
            Bookings
          </Link>
        }
      />
              ...
              <tbody className="divide-y divide-[var(--color-line)]">
                {aging.rows.map((row) => (
                  <tr key={row.id} className="row-hover">
                    <td className="td">
                      <Link
                        href={`/inbox/whatsapp/sales/bookings/${row.bookingId}`}
