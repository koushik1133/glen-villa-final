                  ...
                  <tr key={a.id} className="border-b border-[var(--color-line)]/60 last:border-0">
                    ...
                    <td className="py-2.5">
                      <form action="/api/osf/team" method="POST" className="flex items-center gap-1.5">
                        ...
                        <input type="hidden" name="next" value="/inbox/whatsapp/settings/access" />
                        <select
                          name="role"
                          defaultValue={a.role}
                          className="rounded-md border border-[var(--color-line)] bg-[var(--color-void)] px-2 py-1 text-xs"
                        >
                        ...
                        {a.hasLogin ? (
                          <>
                            <form action="/api/osf/team" method="POST" className="flex items-center gap-1">
                              ...
                              <input
                                ...
                                className="w-28 rounded-md border border-[var(--color-line)] bg-[var(--color-void)] px-2 py-1 text-xs"
                              />
                              <button
                                type="submit"
                                className="rounded-md border border-[var(--color-line)] px-2 py-1 text-xs hover:bg-[var(--color-gold-soft)]"
                            ...
                            <form action="/api/osf/team" method="POST">
                              ...
                              <button
                                ...
                                className="rounded-md border border-[var(--color-line)] px-2 py-1 text-xs text-[var(--color-danger)] hover:bg-[color-mix(in_oklab,var(--c-bad)_8%,transparent)]"
                              >
                                Revoke
                              </button>
                            </form>
                          ...
                          <form action="/api/osf/team" method="POST" className="flex items-center gap-1">
                            ...
                            <button
                              ...
                              className="flex items-center gap-1 rounded-md bg-[var(--color-gold-500)] px-2 py-1 text-xs text-[var(--a-on)] hover:bg-[var(--color-gold-600)] disabled:opacity-40"
                            >
