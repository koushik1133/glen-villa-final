...
export const SENTIMENT_TONES: Record<string, string> = {
  positive: "bg-[color-mix(in_oklab,var(--c-good)_14%,transparent)] text-[var(--color-success)]",
  neutral: "bg-[var(--color-raised)] text-[var(--color-muted)]",
  negative: "bg-[color-mix(in_oklab,var(--c-bad)_14%,transparent)] text-[var(--color-danger)]",
