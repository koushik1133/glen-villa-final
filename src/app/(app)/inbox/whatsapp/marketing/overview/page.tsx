...
import { marketingOverview } from "@/lib/osf/marketing/studio";
  ...
  return (
    <>
      ...
      <Card
        ...
        className="mt-5"
        actions={
          <Link href="/inbox/whatsapp/marketing/campaigns" className="text-xs text-[var(--color-muted)] transition hover:text-[var(--color-gold-300)]">
            All campaigns →
          </Link>
        }
      >
        {topCampaigns.length === 0 ? (
          <Empty
            action={
              <Link href="/inbox/whatsapp/marketing/campaigns" className="btn-ghost">
                Add a campaign
              </Link>
            }
          >
