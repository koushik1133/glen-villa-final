...
import { formats, type ContentFormat } from "@/lib/osf/marketing/formats";
import type { StudioDraft } from "@/lib/osf/marketing/studio";
...
function ConceptFrame({
  ...
  return (
    <div
      ...
      className="relative w-full overflow-hidden bg-[linear-gradient(150deg,var(--s-raised)_0%,var(--s-surface)_55%,var(--s-raised)_100%)]"
    >
...
function Hashtags({ tags, className = "" }: { tags: string[]; className?: string }) {
  ...
  return (
    <p className={`text-[12px] leading-relaxed text-[var(--color-viz-2)] ${className}`}>
...
function PostPreview({ draft, brand }: { draft: StudioDraft; brand: Brand }) {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="w-[352px] max-w-full overflow-hidden rounded-xl border border-[var(--color-line)] bg-[var(--s-surface)] shadow-[0_24px_48px_-24px_rgba(0,0,0,0.9)]">
...
const CHAT_WALLPAPER = {
  ...
  backgroundImage:
    "radial-gradient(circle at 12% 18%, rgba(255,255,255,0.05) 0 1.5px, transparent 2px)," +
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="w-[352px] max-w-full overflow-hidden rounded-xl border border-[var(--color-line)] bg-[var(--s-surface)] shadow-[0_24px_48px_-24px_rgba(0,0,0,0.9)]">
        ...
        <div className="flex items-center gap-3 bg-[var(--s-raised)] px-3 py-2.5">
          <div className="min-w-0 flex-1">
