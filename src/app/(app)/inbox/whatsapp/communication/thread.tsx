...
const BUBBLE_STYLES: Record<MessageRole, string> = {
  ...
  agent: "bg-[color-mix(in_oklab,var(--color-viz-2)_10%,transparent)] text-[var(--color-ink)] rounded-br-sm border border-[color-mix(in_oklab,var(--color-viz-2)_24%,transparent)]",
