...
exports.RULE_BY_ID = exports.RULES = void 0;
...
exports.RULE_BY_ID = Object.fromEntries(exports.RULES.map((r) => [r.id, r]));
...
function taskId(ruleId, leadId, contactId) {
 ...
 */
function diff(drafts, existing, brandId) {
    ...
    return drafts
        ...
        autoGenerated: true,
        rule: d.ruleId,
        notes: exports.RULE_BY_ID[d.ruleId]?.why,
        createdAt: now,
    }));
}
/**
