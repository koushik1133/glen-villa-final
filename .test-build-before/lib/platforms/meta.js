...
exports.facebook = exports.instagram = void 0;
exports.metaGraph = graph;
exports.metaIsRetryable = isRetryable;
const types_1 = require("./types");
const GRAPH = "https://graph.facebook.com";
async function graph(pathname, init) {
    const url = new URL(`${GRAPH}/${(0, types_1.graphVersion)()}/${pathname}`);
...
async function igPublish(req) {
    ...
    try {
        ...
        if (req.format === "carousel") {
            ...
            const mediaType = req.format === "reel" ? "REELS" : req.format === "story" ? "STORIES" : undefined;
        ...
        return { ok: false, error: e.message, retryable: isRetryable(e) };
    }
}
/**
 ...
 */
async function igRateLimit(connection) {
...
exports.instagram = {
    ...
    validate(req) {
        const errors = (0, types_1.baseValidate)(req, exports.instagram.capabilities, "Instagram");
    ...
    publish: async (req) => (types_1.DRIVER === "mock" ? (0, types_1.mockPublish)("instagram", req) : igPublish(req)),
...
exports.facebook = {
    ...
    validate: (req) => (0, types_1.baseValidate)(req, exports.facebook.capabilities, "Facebook"),
    async publish(req) {
        if (types_1.DRIVER === "mock")
            return (0, types_1.mockPublish)("facebook", req);
        const token = req.connection.accessToken;
        ...
        try {
            ...
            const params = { ...(endpoint === "videos" ? { description: message } : { message }) };
            if (req.mediaUrls[0])
                params[isVideo ? "file_url" : "url"] = req.mediaUrls[0];
            if (req.scheduledAt) {
