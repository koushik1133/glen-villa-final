...
exports.ICS_TIMEZONE = void 0;
exports.icsLocal = icsLocal;
 ...
 */
exports.ICS_TIMEZONE = "Asia/Kolkata";
/** "YYYYMMDDTHHMMSS" in the given zone. */
function icsLocal(iso, timeZone = exports.ICS_TIMEZONE) {
...
function fold(line) {
    ...
    while (Buffer.byteLength(rest) > 75) {
        let cut = 75;
        while (cut > 0 && Buffer.byteLength(rest.slice(0, cut)) > 75)
            cut--;
...
function icsFor(a, opts = {}) {
    ...
    const lines = [
        ...
        `DTSTART;TZID=${exports.ICS_TIMEZONE}:${icsLocal(a.startsAt)}`,
        `DTEND;TZID=${exports.ICS_TIMEZONE}:${icsLocal(end)}`,
