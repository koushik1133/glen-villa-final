...
exports.showOperatorDetail = showOperatorDetail;
exports.settingLabel = settingLabel;
exports.redactOperatorText = redactOperatorText;
exports.operatorText = operatorText;
exports.operatorId = operatorId;
exports.operatorNote = operatorNote;
/** True on a vendor-operated deployment, where raw setting names may be shown. */
function showOperatorDetail() {
...
function redactOperatorText(text) {
    let out = text;
    for (const [re, replacement] of SECRET_PATHS)
...
const OPERATOR_NOTES = {
    whatsappVerifyToken: "The value of WHATSAPP_VERIFY_TOKEN in your .env.local — type the same string into Meta.",
    whatsappPublicUrl: "Set NEXT_PUBLIC_APP_URL to that same https URL, or brochure links the agent sends will point at localhost and fail when WhatsApp tries to fetch them.",
};
/** The operator's wording on a vendor deployment, `plain` everywhere else. */
function operatorNote(key, plain) {
