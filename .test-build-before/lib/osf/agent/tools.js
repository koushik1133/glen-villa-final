...
exports.TOOLS = [
    {
        ...
        input_schema: {
            ...
            properties: {
                query: {
                    type: "string",
                    description: "What the customer wants to know, in your own words. e.g. 'clubhouse size and facilities' or 'distance to airport'.",
                },
                project_slug: {
                    type: "string",
                    description: "Optional. Restrict to one project when the customer named it. Omit to search all projects.",
                },
            },
            required: ["query"],
        },
    },
    {
        ...
        input_schema: {
            ...
            properties: {
                ...
                max_budget_inr: {
                    type: "number",
                    description: "Optional. Filter to types at or under this rupee amount. Types with no recorded price are always returned, flagged as unconfirmed.",
                },
    ...
    },
    {
        ...
        description: "Check live unit inventory. Call whenever the customer asks what is available, what is left, how many are unsold, or about a specific unit number. If this reports that no live inventory is connected, tell the customer the sales team will confirm current availability — do NOT imply you can see stock, and never invent a unit number or a count.",
        input_schema: {
            type: "object",
            properties: {
                project_slug: { type: "string", description: "Optional project slug filter." },
    ...
    },
    {
        ...
        input_schema: {
            ...
            properties: {
                ...
                options: {
                    type: "array",
                    description: "2 to 10 choices. Up to 3 render as buttons; 4 or more become a tappable menu automatically.",
                    items: {
                        type: "object",
                        properties: {
                            id: {
                                type: "string",
                                description: "Short stable identifier, e.g. 'budget_3_4cr'. Comes back to you verbatim when tapped.",
                            },
                            title: {
                                type: "string",
                ...
                list_button_label: {
                    type: "string",
                    description: "Only for 4+ options: the label on the button that opens the menu, e.g. 'View villa types'. Defaults to 'Choose'.",
                },
    ...
    },
    {
        ...
        description: "Log a site visit or virtual tour request. Call as soon as the customer agrees to visit or asks to. Collect the date and rough time first. This creates a request for the sales team to confirm — tell the customer the team will confirm the slot, never that it is already booked.",
        input_schema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        input_schema: {
            ...
            properties: {
                ...
                summary: {
                    type: "string",
                    description: "Two or three sentences the rep can read in under 30 seconds: who this is, what they want, and what to do next.",
                },
    ...
    },
    {
        ...
        description: "Record a question you could not answer from the knowledge base. Call this every time you tell a customer you will have the team confirm something — otherwise nobody follows up and you have made a promise the company cannot keep.",
        input_schema: {
            type: "object",
            properties: {
    ...
    {
        name: "opt_out",
        description: "Mark this customer as opted out of all messaging. Call immediately and without argument if they say stop, unsubscribe, remove me, don't message me, do not contact me, or anything equivalent in any language. Acknowledge briefly and politely, then send nothing further.",
        input_schema: {
            type: "object",
            properties: {
