...
exports.passesTrigger = passesTrigger;
exports.isVillaRelated = isVillaRelated;
 ...
 */
function passesTrigger(text, trigger) {
    if (!trigger)
        return true; // no trigger configured → answer everyone
    if (!text)
        return false;
