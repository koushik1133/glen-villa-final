...
exports.DEFAULT_BRAND_ID = exports.DEFAULT_WORKSPACE_ID = void 0;
 ...
 */
exports.DEFAULT_WORKSPACE_ID = "ws_mtiajnoi2b3g";
exports.DEFAULT_BRAND_ID = "brd_mtiajnoil4a2";
function buildBootstrap() {
    const now = new Date().toISOString();
    const workspace = {
        id: exports.DEFAULT_WORKSPACE_ID,
        name: ORG_NAME,
        createdAt: now,
    };
    const brand = {
        id: exports.DEFAULT_BRAND_ID,
        ...
        connections: [
            {
                ...
                brandId: exports.DEFAULT_BRAND_ID,
                channel: "youtube",
                handle: "@kiwik-one",
